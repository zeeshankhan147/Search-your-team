...
export default TrialProgram = ({navigation}) => {
    ...
    return (
        <View style={{flex:1}}>
            ...
            <View style={{flexDirection:'row',justifyContent:'center',width:'90%',height:50,borderRadius:20,alignSelf:'center',
            backgroundColor:'#fff',marginTop:-25}}>
                ...
                <View >
                    <Text style={{fontWeight:'bold',fontSize:15}}>Programs</Text>
                </View>
                </TouchableOpacity>
                ...
                <View >
                    <Text style={{fontWeight:'bold',fontSize:15}}>Schedule</Text>
                </View>
                </TouchableOpacity>
          ...
          {progress? (<View style={{marginBottom:10}}>
